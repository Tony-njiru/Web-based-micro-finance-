            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
						...
						<p class="text-muted">ksh5,000</p>
						<p class="text-muted">Recieve:</p>
						<p class="text-muted">ksh7,000</p>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <p class="text-muted">You make a donation of:</p>
						 <p class="text-muted">ksh20,000</p>
						 <p class="text-muted">Recieve:</p>
						<p class="text-muted">ksh4,000</p>
						<form method="POST" action="package.php">
						<input name="memberid" value="1795" type="hidden">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>GOLD</h3>
                         <p class="text-muted">You make a donation of:</p>
						 <p class="text-muted">ksh40,000</p>
						 <p class="text-muted">Recieve:</p>
						<p class="text-muted">ksh80,000</p>
						<form method="POST" action="package.php">
						<input name="memberid" value="1795" type="hidden">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box">
                        ...
                        <h3>DIAMOND</h3>
                         <p class="text-muted">You make a donation of:</p>
						 <p class="text-muted">ksh50,000</p>
						 <p class="text-muted">Recieve:</p>
						<p class="text-muted">ksh100,000</p>
						<form method="POST" action="package.php">
						<input name="memberid" value="1795" type="hidden">
